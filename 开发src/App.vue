<template>
<div id="chat-app">
    <div title="按[esc]键最大化" class="chat-min" v-if="!temp" @click="chatMainShow = !chatMainShow">
    ...
    <transition name="show">
        <div id="chat-main" v-chat-drop = "chatMainShow" class="chat-main" ref="chatDrop" v-if="chatMainShow">
...
export default {
    ...
    created () {
        ...
        // 请求消息数量
        this.$http.get('/static/omsIm/demo/json/getMembers.json?class=mesNum')
            .then((response) => {
...
Vue.directive('chat-drop', function (elm) {
    Vue.nextTick(function () {
        elm.onmousedown = function (e) {
            var e = e || window.event;
            let marginLeft = elm.offsetWidth/2;
            let disX = e.clientX - this.offsetLeft - marginLeft;
            let disY = e.clientY - this.offsetTop;
            document.onmousemove = function (e){
                var e = e || window.event;
                elm.style.left = (e.clientX - disX) + 'px';
                elm.style.top = (e.clientY - disY) + 'px';
            };
